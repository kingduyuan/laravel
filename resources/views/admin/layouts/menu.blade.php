<ul class="sidebar-menu">
    <li><a href="http://laravel-admin.com/admin"><i class='fa fa-home'></i> <span>Dashboard</span></a></li>
    ...
    <li class="treeview"><a href="http://laravel-admin.com/admin/#"><i class="fa fa-group"></i>
