...
@section('header_title', '权限信息')
@section('header_description', '权限列表')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="updateForm" class="form-horizontal" name="updateForm" action="update">
                        ...
                        <fieldset>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="input-name"> 权限名称 </label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="input-url"> 权限说明 </label>
                                <div class="col-sm-9">
...
//                'lengthChange': false,
            ...
            $(document).on("click", "button.table-update", function (e) {
                ...
                $("#updateForm").prop("action", "{{ url('/admin/permissions/update') }}");
                $("#updateModal").modal();
            });
            ...
            $("#create").click(function (e) {
                ...
                $("#updateForm").prop("action", "{{ url('/admin/permissions/create') }}");
                $("#updateModal").modal();
            });
